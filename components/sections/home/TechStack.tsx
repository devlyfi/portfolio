        ...
        <section className="py-0 border-b border-border/40 overflow-hidden bg-muted/3">
            <div className="container px-4 mx-auto">
                <div className="flex flex-col lg:flex-row border-x border-border/40 divide-y lg:divide-y-0 lg:divide-x divide-border/40">
                    ...
                    {/* Infinite Marquee */}
                    <div className="lg:w-2/3 py-20 lg:py-0 flex items-center relative group overflow-hidden bg-background/40">
                        <div className="flex animate-marquee space-x-0 items-center hover:pause">
                            {[...technologies, ...technologies, ...technologies].map((tech, index) => (
                                <div key={index} className="flex items-center">
                                    <span className="text-sm md:text-base font-bold tracking-[0.3em] text-muted-foreground/80 hover:text-primary transition-all duration-300 cursor-default px-16 uppercase whitespace-nowrap">
                                        {tech}
                                    </span>
