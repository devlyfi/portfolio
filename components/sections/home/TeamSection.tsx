...
export function TeamSection({
    ...
    subtitle = "The dedicated engineering unit driving high-performance, scalable, and resilient digital infrastructure.",
    isDark = false,
    isCarousel = false
}: TeamSectionProps) {
    ...
    useLayoutEffect(() => {
        const ctx = gsap.context(() => {
            ...
            mm.add("(min-width: 1024px)", () => {
                ...
                if (!section || !wrapper || !isCarousel) return;
    ...
    const [emblaRef, emblaApi] = useEmblaCarousel({
        ...
        breakpoints: {
            ...
            "(min-width: 1024px)": { active: false } // Disable Embla on desktop as GSAP handles it
        }
    });
            ...
            <div className="container px-4 mx-auto">
                ...
                <div className="flex flex-col lg:flex-row border-x border-border/40 divide-y lg:divide-y-0 lg:divide-x divide-border/40 border-b border-border/40 bg-background/40">
                    ...
                    <div className="lg:w-1/3 p-8 lg:p-16 flex flex-col justify-center space-y-10 bg-muted/2 relative">
                        <p className="text-[11px]  uppercase leading-[2] tracking-[0.3em] font-medium opacity-60 border-l border-primary/20 pl-8">
                            {subtitle}
                        </p>
                                        ...
                                        <div className="group h-full relative border-r border-border/40">
                                            ...
                                            <div className="p-10 lg:p-14 space-y-8 flex flex-col justify-between bg-background group-hover:bg-muted/5 transition-all duration-700 h-full lg:h-auto">
                                                <div className="space-y-6">
                                                    ...
                                                    <p className="text-[11px]  uppercase leading-[2] tracking-[0.2em] font-medium opacity-50 group-hover:opacity-100 transition-opacity line-clamp-3">
                                                        {member.bio}
                                                    </p>
                                                </div>
                                            </div>
