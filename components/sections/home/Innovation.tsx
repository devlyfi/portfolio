                ...
                <div className="flex flex-col lg:flex-row border-x border-border/40">
                    ...
                    <div className="w-full lg:w-1/3 p-10 lg:p-16 xl:p-24 space-y-12 relative bg-muted/5 border-b lg:border-b-0 lg:border-r border-border/40">
                        <div className="space-y-6">
                            <span className="text-[10px] font-black text-primary uppercase tracking-[0.5em] block animate-pulse">/INNOVATION</span>
                            <h2 className="display-bold text-3xl lg:text-3xl xl:text-5xl uppercase tracking-tighter !leading-[0.9]"> Research<br />
                                & Engineering<br />
                                Initiatives</h2>
                        </div>
                        <p className="text-[11px] uppercase tracking-[0.3em] leading-relaxed opacity-80 max-w-sm">Exploring emerging technologies, sustainable practices, and community-driven engineering to continuously improve our systems.</p>
                        ...
                        {[
                            {
                                ...
                                desc: "Internal projects exploring AI, decentralized systems, and performance-optimized architectures.",
                                icon: Cpu,
                                marker: "/LAB_01"
                            },
                            {
                                title: "Open Source Contributions",
                                desc: "Maintaining and contributing to libraries and tools for the wider engineering community.",
                                icon: Github,
                                marker: "/CONTRIB"
                            },
                            {
                                title: "Sustainable Engineering",
                                desc: "Designing systems with energy efficiency and eco-friendly infrastructure in mind.",
                                icon: Leaf,
                                marker: "/ECO_INIT"
                            }
                        ]
